            ...
            <div class="container pt-4">
                <div class="row">
                        ...
                        <div class="search-location">
                            ...
                            <div class="select-city select-radio-ft mt-3 pt-1">
                                <ul class="select-city-list">
                                    <li><p class="city-name">Mumbai</p></li>
                                    <li><p class="city-name">Delhi</p></li>
                                    <li><p class="city-name">New Delhi</p></li>
                                    <li><p class="city-name">Ahmedabad</p></li>
                                    <li><p class="city-name">Bengaluru</p></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-9">
                        <div class="results-found mb-md-1 d-flex align-items-center">
                            <h1 style="font-size: 25px;">Jeans</h1>
                            <span class="ml-1">(270 Results)</span>
                        </div>
                        
                        <div class="d-flex bwmdfO" id="fran-fran-select">
                            <p class="fDTEWU fran-active bg-one">Distributor</p>
                            <p class="fDTEWU bg-one ml-3">Franchise</p>
                        </div>
                        ...
                        <div class="col-12 mb-5 custom-width">
                            <div class="company-form">
                                <div class="eExjwc askForm">
                                    ...
                                    <div class="d-flex bwmdfO company-top mb-2" id="fran-fran-select">
                                        <p class="fDTEWU fran-active bg-one">Distributor</p>
                                        <p class="fDTEWU bg-one ml-3">Franchise</p>
                                    </div>
...
<script>
    let franchise = document.getElementById("fran-fran-select");
    let fran_btns = franchise.getElementsByClassName("bg-one");
        for (let i = 0; i < fran_btns.length; i++) {
            fran_btns[i].addEventListener("click", function () {
                let current = document.getElementsByClassName("fran-active");
                current[0].className = current[0].className.replace(" fran-active", "");
                this.className += " fran-active";
            });
        };
